...
export function CapsuleNode({
  ...
  // Measure the text to size the shape
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <ShapeRenderer
        ...
        height={h}
        fillColor={fillColor}
        borderColor={isSelectedForStyle ? "hsl(215, 60%, 45%)" : isSelected && isConnecting ? "hsl(215, 60%, 45%)" : borderColor}
      />
      ...
      {isSelectedForStyle && !isConnecting && (
      ...
      {isEditing ? (
        ...
        <span
          data-text-content
          className="relative z-10 text-sm font-medium text-foreground whitespace-nowrap max-w-[180px] truncate px-4"
        >
          {text}
        </span>
      )}
