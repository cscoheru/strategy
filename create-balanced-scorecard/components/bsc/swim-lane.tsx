...
interface SwimLaneProps {
  ...
  onConnectionTarget: (laneId: string, capsuleId: string) => void
}
      ...
      <div className="relative flex-1" style={{ height: laneHeight }}>
        {capsules.map((capsule) => (
          <CapsuleNode
            ...
            isSelectedForStyle={selectedCapsuleId === capsule.id}
            ...
            isSelected={pendingFrom === capsule.id}
            onConnectionTarget={(capId) => onConnectionTarget(id, capId)}
          />
        ))}
